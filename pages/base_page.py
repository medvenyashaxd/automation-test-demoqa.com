...
class BasePage:
    ...
    def elements_are_visible(self, locator, timeout=5):
        return Wait(self.__driver, timeout).until(ec.visibility_of_all_elements_located(locator))
    ...
    def element_is_not_visible(self, locator, timeout=5):
        return Wait(self.__driver, timeout).until(ec.invisibility_of_element_located(locator))

    @allure.step('Finds a clickable element')
    def element_is_clickable(self, locator, timeout=5):
        return Wait(self.__driver, timeout).until(ec.element_to_be_clickable(locator))
    ...
    def switch_to_window(self, amount):
        self.__driver.switch_to.window(self.__driver.window_handles[amount])
    ...
    def page_scale(self):
        self.__driver.execute_script("document.body.style.zoom = '0.9'")
